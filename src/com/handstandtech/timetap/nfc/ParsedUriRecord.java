 ...
 */
public class ParsedUriRecord {

    private static final String TAG = "ParsedUriRecord";

    public static final String RECORD_TYPE = "ParsedUriRecord";
    ...
    private ParsedUriRecord(Uri uri) {
